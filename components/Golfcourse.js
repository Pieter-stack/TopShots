...
const [course, setCourse]= useState([]);
 ...
 // console.log(scorecardid is very important)
      ...
      >
        <View style={[styles.centeredView, { marginTop: Platform.OS === 'ios' ? height * 0.06 : height * 0.03 }]}>
          <View style={styles.modalView}>
            {/* <Text style={styles.modalText}>{score?.hole1}</Text> */}
            {/* <Text style={styles.venuetitle}>{finalscore}</Text> */}
            {Platform.OS === 'ios' ?
            <>
